# AutomaLead Frontend — Trademark and Brand Assets Policy

Version 1.0, 2026.05.06

"Evolution Foundation", "Evolution" and "AutomaLead Frontend" are trademarks of
AutomaLead The "evocrm-frontend" wordmark and the AutomaLead Frontend
logo are trademarks of AutomaLead

## 1. Scope and purpose

This policy governs the use of AutomaLead Frontend trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
AutomaLead Frontend visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "AutomaLead Frontend";
...
(d) any materials that implement or express the AutomaLead Frontend official look
...
2.1. You may truthfully refer to AutomaLead Frontend to describe that your software
is based on, compatible with, or derived from this project, provided that such
use does not imply endorsement by AutomaLead

2.2. You may distribute and publicly host unmodified official builds of
AutomaLead Frontend that include AutomaLead Frontend brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use AutomaLead Frontend marks in nominative ways, such as
"based on AutomaLead Frontend", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "AutomaLead Frontend";
...
AutomaLead Frontend brand assets.** If you distribute or publicly host any version
of the user interface that uses AutomaLead Frontend brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove AutomaLead Frontend brand assets.**
...
(a) remove and replace all AutomaLead Frontend trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from AutomaLead Frontend.

4.3. **No endorsement.**
You may not use AutomaLead Frontend trademarks or brand assets in a way that
...
AutomaLead Frontend logo or wordmark.

## 5. Permission requests

Any use not expressly permitted by this policy requires prior written permission
from AutomaLead Contact: **suporte@evofoundation.com.br**.

## 6. Enforcement and termination

Any violation of this policy terminates your permission to use AutomaLead Frontend
brand assets. You must promptly cease use and remove AutomaLead Frontend trademarks
